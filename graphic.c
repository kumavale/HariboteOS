...
void init_palette(void)
{
    static unsigned char table_rgb[16 * 3] = {
        ...
        0x41, 0x69, 0xe1,  /* 14: Dark Aqua    */  /* 0x00, 0x84, 0x84 */
...
void init_screen8(unsigned char *vram, short xsize, short ysize)
{
    ...
    if (task->langmode == 1) {
        for (; *s != 0x00; ++s) {
            if (task->langbyte1 == 0) {
                ...
                putfont8(vram, xsize, x - 8, y, c, font     );  /* Half left */
                putfont8(vram, xsize, x    , y, c, font + 16);  /* Half right */
            }
            x += 8;
        }
    }
